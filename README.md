...
[![Last Update](https://img.shields.io/github/last-commit/maxbogo/awesome-ai-tools-for-ui?label=Last%20update\&style=classic)](https://github.com/maxbogo/awesome-ai-tools-for-ui) ⭐ 857 | 🐛 12 | 📅 2026-07-06
...
* [Anthropic Frontend Design Skill](https://github.com/anthropics/skills/tree/main/skills/frontend-design?utm_source=awesome-ai-tools-for-ui) ⭐ 174,358 | 🐛 1,207 | 🌐 Python | 📅 2026-09-03 - Teaches Claude to build frontend UIs with strong visual direction instead of generic defaults.
* [UI UX Pro Max Skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill?utm_source=awesome-ai-tools-for-ui) ⭐ 125,141 | 🐛 87 | 🌐 Python | 📅 2026-09-03 - Generates design systems (colors, typography, layouts) based on your project type and framework.
* [Awesome DESIGN.md](https://github.com/VoltAgent/awesome-design-md/?utm_source=awesome-ai-tools-for-ui) ⭐ 114,197 | 🐛 321 | 📅 2026-07-31 - Curated collection of DESIGN.md files inspired by developer-focused websites.
* [Emil Kowalski Skill](https://github.com/emilkowalski/skill?utm_source=awesome-ai-tools-for-ui) ⭐ 35,575 | 🐛 1 | 🌐 Markdown | 📅 2026-08-21 - Skill file based on Emil Kowalski's UI articles, aimed at designers and engineers building better interfaces.
* [Web Design Guidelines Skill](https://github.com/vercel-labs/agent-skills/blob/main/skills/web-design-guidelines/SKILL.md?utm_source=awesome-ai-tools-for-ui) ⭐ 30,858 | 🐛 174 | 🌐 JavaScript | 📅 2026-08-28 - Checks your UI code against web design best practices and flags violations.
* [Hallmark](https://github.com/nutlope/hallmark?utm_source=awesome-ai-tools-for-ui) ⭐ 28,098 | 🐛 45 | 🌐 CSS | 📅 2026-08-06 - Design skill for Claude Code, Cursor, and Codex that audits and generates UI against anti-slop design gates.
* [Huashu Design](https://github.com/alchaincyf/huashu-design?utm_source=awesome-ai-tools-for-ui) ⭐ 23,892 | 🐛 4 | 🌐 HTML | 📅 2026-08-25 - HTML-native design skill for generating prototypes, slides, animations, and design reviews from agent prompts.
...
* [Make Interfaces Feel Better](https://github.com/jakubkrehel/make-interfaces-feel-better?utm_source=awesome-ai-tools-for-ui) ⭐ 3,340 | 🐛 1 | 🌐 Markdown | 📅 2026-08-29 - Agent skill that teaches small design engineering details that compound into better interfaces.
* [Three.js Skills](https://github.com/CloudAI-X/threejs-skills?utm_source=awesome-ai-tools-for-ui) ⭐ 3,240 | 🐛 9 | 📅 2026-07-09 - Collection of Three.js skills covering scenes, geometry, lighting, shaders, loaders, animation, and interaction.
* [Nothing Design Skill](https://github.com/dominikmartn/nothing-design-skill?utm_source=awesome-ai-tools-for-ui) ⭐ 2,772 | 🐛 3 | 📅 2026-04-01 - Claude Code skill for producing Nothing-inspired monochrome, typographic, industrial UI.
* [Designer Skills Collection](https://github.com/Owl-Listener/designer-skills?utm_source=awesome-ai-tools-for-ui) ⭐ 2,506 | 🐛 3 | 🌐 Markdown | 📅 2026-09-05 - Pack of skills and commands — from research to systems, UI, interaction, and delivery.
* [Material Design 3 Skill](https://github.com/hamen/material-3-skill?utm_source=awesome-ai-tools-for-ui) ⭐ 1,353 | 🐛 2 | 🌐 Shell | 📅 2026-07-15 - Portable Material Design 3 skill covering tokens, theming, 30+ components, responsive layout, and MD3 audits.
* [StyleSeed](https://github.com/bitjaru/styleseed?utm_source=awesome-ai-tools-for-ui) ⭐ 943 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-03 - Design rules and slash-command skills that give agents design judgment — coherence, hierarchy, UX-writing.
* [Bencium Marketplace](https://github.com/bencium/bencium-marketplace?utm_source=awesome-ai-tools-for-ui) ⭐ 418 | 🐛 0 | 🌐 Shell | 📅 2026-08-30 - Claude Code plugin marketplace with skills for design, architecture, productivity, typography, and code review.
...
* [Open Design](https://github.com/nexu-io/open-design?utm_source=awesome-ai-tools-for-ui) ⭐ 94,191 | 🐛 935 | 🌐 TypeScript | 📅 2026-09-05 - Local-first, open-source alternative to Claude Design for generating prototypes, slides, images, and videos.
* [AI Website Cloner](https://github.com/JCodesMore/ai-website-cloner-template?utm_source=awesome-ai-tools-for-ui) ⭐ 33,871 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-14 - Clone any website into a Next.js codebase with one command using AI agents.
...
* [Magic MCP](https://github.com/21st-dev/magic-mcp?utm_source=awesome-ai-tools-for-ui) ⭐ 5,798 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - Generate UI components from text prompts inside Cursor, Windsurf, and VSCode.
* [Interface Design](https://github.com/Dammyjay93/interface-design?utm_source=awesome-ai-tools-for-ui) ⭐ 5,660 | 🐛 8 | 🌐 Shell | 📅 2026-06-20 - Claude Code plugin for remembering interface decisions across sessions and keeping UI systems consistent.
* [Design and Refine](https://github.com/0xdesign/design-plugin?utm_source=awesome-ai-tools-for-ui) ⭐ 753 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-06 - Claude Code plugin for generating, comparing, and refining multiple UI variations in your codebase.
...
* [Beautiful HTML Templates](https://github.com/zarazhangrui/beautiful-html-templates?utm_source=awesome-ai-tools-for-ui) ⭐ 4,483 | 🐛 1 | 🌐 HTML | 📅 2026-06-09 - Agent-ready library of reusable HTML slide templates for generating polished decks.
* [Paper Shaders](https://github.com/paper-design/shaders?utm_source=awesome-ai-tools-for-ui) ⭐ 3,420 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-04 - Zero-dependency canvas shaders for adding customizable animated backgrounds, textures, and masked effects to websites.
